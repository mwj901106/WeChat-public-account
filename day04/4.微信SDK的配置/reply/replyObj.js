...
function buildReplyObj(userData) {
  ...
  else if(userData.Content === '我要搜电影'){
    obj.MsgType = 'text'
    obj.Content = '<a href="http://e47b2967.ngrok.io/search">点我搜索</a>'
    return obj
  }
  //如果用户发送的是图片，返回这个图片
  ...
  else if(userData.Content === '来个视频'){
    obj.MsgType = 'video'
    obj.MediaId = 'FNrOhYo0lfehXZVkCk0AWzw-GYY94wntwUEVnxHvzHoZBAUELSo7BraWz_qIthOB'
    obj.Title = '尚硅谷公众号教程（一）'
    obj.Description = '使用NodeJS进行公众号开发'
    return obj
  }
