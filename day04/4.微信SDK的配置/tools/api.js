...
module.exports = {
  ...
  message:{
    senMessageByTags:`${baseUrl}message/mass/sendall?`
  },
  material:{
    //临时素材相关接口
    tmp:{
      uploadTmp:`${baseUrl}media/upload?`
    },
    perpetual:{
      uploadPerImageOfNews:`${baseUrl}media/uploadimg?`,
      uploadPer:`${baseUrl}material/add_material?`,
      deleteMater:`${baseUrl}material/del_material?`
    },
    getMaterialCount:`${baseUrl}material/get_materialcount?`,
    getMaterialList:`${baseUrl}material/batchget_material?`
  },
  getTicket:`${baseUrl}ticket/getticket?`
